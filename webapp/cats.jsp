...
<%
    ResultSet rs = PetDao.selectSpecies("Gato");
%>
        ...
        <div class="row justify-content-md-center">
            <div class="col col-md-12">
                <div class="card text-center border-dark">
                    <div class="card-header">List of Cats</div>
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <a href="new-pet.jsp?species=cat" class="btn btn-outline-secondary">+ Register Cat</a>
                        </div>
