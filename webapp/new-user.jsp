        ...
        <div class="card text-center border-dark">
            ...
            <div class="card-body text-center">
                <form>
                    ...
                    <div class="row g-3 p-3">
                        <div class="col">
                            <input type="email" class="form-control" placeholder="E-mail" aria-label="E-mail" name="email">
                        </div>
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Contacto" aria-label="contacto" name="contacto">
                        </div>
                    </div> 
                    <div class="row g-3 p-3">
                        <div class="col">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" placeholder="ZIP Code" aria-label="ZIP" name="ZIP">
                        </div>
                    </div>
                    <div class="row g-3 p-3">
                        <div class="col">
